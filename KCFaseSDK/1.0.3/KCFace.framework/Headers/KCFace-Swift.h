...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KCFace",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC6KCFace11ChrysanView")
@interface ChrysanView : UIView
...
SWIFT_CLASS("_TtC6KCFace20KCFaceViewController")
@interface KCFaceViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6KCFace18KCLayoutConstraint")
@interface KCLayoutConstraint : NSLayoutConstraint
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface KCLayoutConstraint (SWIFT_EXTENSION(KCFace))
...
SWIFT_CLASS("_TtC6KCFace17KCSessionDelegate")
@interface KCSessionDelegate : NSObject
...
@interface KCSessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDownloadDelegate>
...
@interface KCSessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDelegate>
...
@interface KCSessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDataDelegate>
...
@interface KCSessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionStreamDelegate>
...
@interface KCSessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionTaskDelegate>
