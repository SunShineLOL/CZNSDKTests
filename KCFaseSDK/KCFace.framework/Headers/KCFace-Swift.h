...
SWIFT_CLASS("_TtC6KCFace16LayoutConstraint")
@interface LayoutConstraint : NSLayoutConstraint
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface LayoutConstraint (SWIFT_EXTENSION(KCFace))
...
SWIFT_CLASS("_TtC6KCFace15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(KCFace)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC6KCFace12TaskDelegate")
